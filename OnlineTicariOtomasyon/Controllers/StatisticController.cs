...
namespace OnlineTicariOtomasyon.Controllers
{
    public class StatisticController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var deger8 = (from x in c.Products orderby x.SellingPrice descending select x.ProductName).FirstOrDefault();
            ViewBag.d8 = deger8;

            var deger9 = (from x in c.Products orderby x.SellingPrice ascending select x.ProductName).FirstOrDefault();
            ViewBag.d9 = deger9;

            var deger10 = c.SalesTransactions
                .Sum(x => (decimal?)x.SalesTransactionsPrice) ?? 0;
            return View();
